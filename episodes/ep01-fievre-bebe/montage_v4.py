"""Montage v4 : base = v1 (contenu conforme au script validé, trucages fonctionnels),
voix naturelle (plus d'effet de voix grave), rythme resserré par accélération globale.

Usage : python3 montage_v4.py            → out/ep01_montage_v4.mp4
        python3 montage_v4.py --voix-brute → même montage sans traitement de la voix
...
TMP = os.path.join(OUT, "tmp_montage_v4")
...
SECTIONS = [
    ...
    dict(nom="Appel à l'action", audio=[("205005", 0.00, 3.10), ("205005", 4.60, 7.20)], video=[
        ...
        ("205005", 4.60, 7.20, "punch"),  # 6.60→7.20 : « commentaire » était coupé avant sa fin réelle (~7.12 s)
    ]),
]
...
SUBS = [
    ...
    (7, 3.10, 5.70, "Écris un seul mot en commentaire."),
]
...
def main():
    ...
    dst = a.sortie or os.path.join(OUT, "ep01_montage_v4_voix-brute.mp4" if a.voix_brute else "ep01_montage_v4.mp4")
